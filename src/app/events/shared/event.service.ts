...
export class EventService {
    getEvents():Observable<IEvent[]> {
      ...
      setTimeout(() => {subject.next(EventsData); subject.complete();}, 1000);
      return subject;  
    }
    ...
    updateEvent(event: IEvent){
      let index = EventsData.findIndex(x => x.id = event.id);
...
const EventsData: IEvent[] = [
    {
      ...
      time: '10:00 am',
      price: 599.99,
      imageUrl: '/assets/images/yuxiPicture.png',
      location: {
        address: '1057 DT',
        city: 'London',
        country: 'England'
    ...
    },
    {
      ...
      price: 950.00,
      imageUrl: '/assets/images/yuxiPicture.png',
      onlineUrl: 'www.ng-nl.com.com/tickets/',
      sessions: [
        {
          id: 1,
